  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-primary-foreground hover:text-[#FDB532] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-primary-foreground/80 hover:text-[#FDB532] transition-colors">
                  Inicio
                </a>
              </li>
              <li>
                <a href="#metrics" className="text-primary-foreground/80 hover:text-[#FDB532] transition-colors">
                  Métricas
                </a>
              </li>
              <li>
                <a href="#dashboard" className="text-primary-foreground/80 hover:text-[#FDB532] transition-colors">
                  Dashboard
                </a>
              </li>
            </ul>
        ...
        <div className="mt-10 pt-6 border-t border-primary-foreground/20 text-center text-primary-foreground/60">
