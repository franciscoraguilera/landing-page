...
function Header() {
  ...
  return (
    <motion.header
      className="bg-[#0c022f] text-white py-4 px-6 md:px-10"
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <a href="#metrics" className="text-white hover:text-white/80 transition-colors">
            Métricas
          </a>
        ...
        <div className="md:hidden">
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" className="bg-[#0c022f] text-white">
